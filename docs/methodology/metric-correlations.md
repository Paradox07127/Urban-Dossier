...
Frame: 7,196 H3 r9 cells (union of H3 r9 cells across all H3 score tables); absent cells are genuine zeros. Statistic: Spearman on zero-filled raw counts. With this many cells every p-value rounds to zero, so magnitudes are the finding, not significance.

## Declared relationships, measured

The metric registry declares two suspect relationships. Both hold:

- `311_sanitation` vs `rodent` -- declared overlap: **rho = +0.651**
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `collision` | +1.00 | +0.55 | +0.74 | +0.34 | +0.48 | +0.38 | +0.20 | +0.43 | +0.15 | +0.41 | +0.66 | +0.61 | +0.70 | +0.30 |
| `rodent` | +0.55 | +1.00 | +0.65 | +0.21 | +0.30 | +0.25 | +0.12 | +0.42 | +0.11 | +0.23 | +0.43 | +0.44 | +0.60 | +0.23 |
| `311_sanitation` | +0.74 | +0.65 | +1.00 | +0.28 | +0.40 | +0.30 | +0.21 | +0.60 | +0.14 | +0.36 | +0.57 | +0.60 | +0.93 | +0.41 |
| `subway` | +0.34 | +0.21 | +0.28 | +1.00 | +0.24 | +0.21 | +0.12 | +0.11 | +0.09 | +0.35 | +0.39 | +0.31 | +0.27 | +0.15 |
| `bus` | +0.48 | +0.30 | +0.40 | +0.24 | +1.00 | +0.25 | +0.12 | +0.22 | +0.13 | +0.31 | +0.47 | +0.40 | +0.37 | +0.16 |
| `bike_routes` | +0.38 | +0.25 | +0.30 | +0.21 | +0.25 | +1.00 | +0.17 | +0.11 | +0.17 | +0.27 | +0.31 | +0.34 | +0.27 | +0.18 |
| `open_streets` | +0.20 | +0.12 | +0.21 | +0.12 | +0.12 | +0.17 | +1.00 | +0.15 | +0.06 | +0.22 | +0.22 | +0.21 | +0.20 | +0.13 |
| `trees` | +0.43 | +0.42 | +0.60 | +0.11 | +0.22 | +0.11 | +0.15 | +1.00 | +0.05 | +0.21 | +0.32 | +0.29 | +0.59 | +0.23 |
| `public_toilets` | +0.15 | +0.11 | +0.14 | +0.09 | +0.13 | +0.17 | +0.06 | +0.05 | +1.00 | +0.10 | +0.15 | +0.23 | +0.13 | +0.07 |
| `linknyc` | +0.41 | +0.23 | +0.36 | +0.35 | +0.31 | +0.27 | +0.22 | +0.21 | +0.10 | +1.00 | +0.44 | +0.39 | +0.33 | +0.18 |
| `restaurant_context` | +0.66 | +0.43 | +0.57 | +0.39 | +0.47 | +0.31 | +0.22 | +0.32 | +0.15 | +0.44 | +1.00 | +0.56 | +0.54 | +0.25 |
| `facilities` | +0.61 | +0.44 | +0.60 | +0.31 | +0.40 | +0.34 | +0.21 | +0.29 | +0.23 | +0.39 | +0.56 | +1.00 | +0.57 | +0.28 |
| `housing_violations` | +0.70 | +0.60 | +0.93 | +0.27 | +0.37 | +0.27 | +0.20 | +0.59 | +0.13 | +0.33 | +0.54 | +0.57 | +1.00 | +0.43 |
| `aep` | +0.30 | +0.23 | +0.41 | +0.15 | +0.16 | +0.18 | +0.13 | +0.23 | +0.07 | +0.18 | +0.25 | +0.28 | +0.43 | +1.00 |
