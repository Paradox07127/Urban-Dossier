...
- `collision` vs `collision_transport` -- same source file (`safety/motor_vehicle_collisions.csv`): **rho = +1.000**
...
| --- | --- | --- | --- | --- |
| `collision` / `collision_transport` | +1.000 | +1.000 | 6,723 | collinear |
...
| `311_sanitation` / `collision_transport` | +0.740 | +0.661 | 6,137 | high |
| `collision` / `rodent` | +0.721 | +0.627 | 5,722 | high |
| `rodent` / `collision_transport` | +0.721 | +0.627 | 5,722 | high |
| `collision` / `housing_violations` | +0.701 | +0.609 | 5,480 | high |
| `collision_transport` / `housing_violations` | +0.701 | +0.609 | 5,480 | high |
...
| | `collision` | `rodent` | `311_sanitation` | `collision_transport` | `subway` | `bus` | `bike_routes` | `open_streets` | `trees` | `public_toilets` | `linknyc` | `restaurant_context` | `facilities` | `housing_violations` | `aep` |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `collision` | +1.00 | +0.72 | +0.74 | +1.00 | +0.34 | +0.48 | +0.38 | +0.20 | +0.43 | +0.15 | +0.41 | +0.66 | +0.62 | +0.70 | +0.30 |
| `rodent` | +0.72 | +1.00 | +0.90 | +0.72 | +0.29 | +0.39 | +0.31 | +0.22 | +0.57 | +0.14 | +0.39 | +0.58 | +0.59 | +0.87 | +0.39 |
| `311_sanitation` | +0.74 | +0.90 | +1.00 | +0.74 | +0.28 | +0.40 | +0.31 | +0.21 | +0.60 | +0.14 | +0.36 | +0.57 | +0.60 | +0.93 | +0.41 |
| `collision_transport` | +1.00 | +0.72 | +0.74 | +1.00 | +0.34 | +0.48 | +0.38 | +0.20 | +0.43 | +0.15 | +0.41 | +0.66 | +0.62 | +0.70 | +0.30 |
| `subway` | +0.34 | +0.29 | +0.28 | +0.34 | +1.00 | +0.24 | +0.21 | +0.12 | +0.11 | +0.09 | +0.35 | +0.39 | +0.31 | +0.27 | +0.15 |
| `bus` | +0.48 | +0.39 | +0.40 | +0.48 | +0.24 | +1.00 | +0.25 | +0.12 | +0.22 | +0.13 | +0.31 | +0.47 | +0.40 | +0.37 | +0.16 |
| `bike_routes` | +0.38 | +0.31 | +0.31 | +0.38 | +0.21 | +0.25 | +1.00 | +0.17 | +0.11 | +0.17 | +0.27 | +0.31 | +0.34 | +0.27 | +0.18 |
| `open_streets` | +0.20 | +0.22 | +0.21 | +0.20 | +0.12 | +0.12 | +0.17 | +1.00 | +0.15 | +0.06 | +0.22 | +0.22 | +0.21 | +0.20 | +0.13 |
| `trees` | +0.43 | +0.57 | +0.60 | +0.43 | +0.11 | +0.22 | +0.11 | +0.15 | +1.00 | +0.05 | +0.21 | +0.32 | +0.29 | +0.60 | +0.23 |
| `public_toilets` | +0.15 | +0.14 | +0.14 | +0.15 | +0.09 | +0.13 | +0.17 | +0.06 | +0.05 | +1.00 | +0.10 | +0.15 | +0.23 | +0.14 | +0.07 |
| `linknyc` | +0.41 | +0.39 | +0.36 | +0.41 | +0.35 | +0.31 | +0.27 | +0.22 | +0.21 | +0.10 | +1.00 | +0.44 | +0.39 | +0.33 | +0.18 |
| `restaurant_context` | +0.66 | +0.58 | +0.57 | +0.66 | +0.39 | +0.47 | +0.31 | +0.22 | +0.32 | +0.15 | +0.44 | +1.00 | +0.56 | +0.54 | +0.25 |
| `facilities` | +0.62 | +0.59 | +0.60 | +0.62 | +0.31 | +0.40 | +0.34 | +0.21 | +0.29 | +0.23 | +0.39 | +0.56 | +1.00 | +0.57 | +0.28 |
| `housing_violations` | +0.70 | +0.87 | +0.93 | +0.70 | +0.27 | +0.37 | +0.27 | +0.20 | +0.60 | +0.14 | +0.33 | +0.54 | +0.57 | +1.00 | +0.43 |
| `aep` | +0.30 | +0.39 | +0.41 | +0.30 | +0.15 | +0.16 | +0.18 | +0.13 | +0.23 | +0.07 | +0.18 | +0.25 | +0.28 | +0.43 | +1.00 |
